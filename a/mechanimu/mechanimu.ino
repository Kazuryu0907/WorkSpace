    ...
    if (PS4.connected()) { //通信中に実行
      ...
      if (Serial.available() > 0) {
        ...
        if (val == 'F') {
          ...
          Serial.write(lowByte(re_x*2));
          Serial.write(highByte(re_x*2));
          ...
          Serial.write(lowByte(re_y*2));
          Serial.write(highByte(re_y*2));
          
          Serial.write('A');
          Serial.write(lowByte(rad));
          Serial.write(highByte(rad));
