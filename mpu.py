...
def get_accel_data_lsb():
    ...
    print("accel_x(raw): {0} accel_y(raw): {1} accel_z(raw): {2}".format(x,y,z),end="")
    """
    return([x, y, z])
...
while 1:
    ...
    print("\rgyro_x(raw): {0} gyro_y(raw): {1} gyro_z(raw): {2} accel_x(raw): {3} accel_y(raw): {4} accel_z(raw): {5}".format(gyro_x,gyro_y,gyro_z,accel_x,accel_y,accel_z),end=''s)
